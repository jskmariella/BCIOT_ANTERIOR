       ...
       // Button buttonMS4 = (Button) findViewById(R.id.buttonMS4);
        ...
        buttonMS13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTitle("Endereço de Envio");
                dialog.setMessage("BSV ADD:");
                ...
                dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Variables.ArduinoBSVAdd = ETdialog_PIN.getText().toString();

                        if(Variables.ArduinoBSVAdd.substring(0,1).compareTo("1") == 0) {
