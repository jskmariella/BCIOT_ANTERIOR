...
///////////////////////////////////////////////////////////////////////////////
    ...
    public String txHexRead (String TXID)
    {
        ...
        bsvTX.txID(Variables.ArduinoLastTX);
        if(TXID.compareTo(bsvTX.TXID)==0)
        {
            TXToSeach = Variables.ArduinoLastTX;
            return TXToSeach;
        }
        ...
        */
        ...
        if(bsvTX.TxHexData == null) {
            ...
            return  "Error: Time out reading TX HEX DATA 0XX";
    ...
    public String txHexReadSCRIPT (String TXID)
    {
        ...
        */
        ...
        if(bsvTX.TxHexData == null) {
            //String[] TxPreimageOutFail = new String[1];
            return  "Error: Time out reading TX HEX DATA 01";
            //return TxPreimageOutFail;
        }
