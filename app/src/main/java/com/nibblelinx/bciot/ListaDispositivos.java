...
public class ListaDispositivos extends ListActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Set<BluetoothDevice> dispositvospareados =  meuBluetoothAdapter2.getBondedDevices();

        if(dispositvospareados.size() > 0){
            for(BluetoothDevice dispositivo : dispositvospareados){
